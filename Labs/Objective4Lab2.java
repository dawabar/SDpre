...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    System.out.println
      ("Please enter the first decimal number you want to add:");
    dub1 = keyboard.nextDouble();
    System.out.println
      ("Please enter the second decimal number you want to add:");
    dub2 = keyboard.nextDouble();
    System.out.println
      ("Please enter the third decimal number you want to add:");
    dub3 = keyboard.nextDouble();
    int summedIntegers = num1 + num2 + num3;
    double summedDecimals = dub1 + dub2 + dub3;
